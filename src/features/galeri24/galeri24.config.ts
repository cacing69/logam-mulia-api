...
export const galeri24Config: ScrapingConfig<'price' | 'buybackPrice' | 'type' | 'info'> = {
	engine: 'cheerio',
	currency: 'IDR',
	...
	items: [
		{
			selector: {
				price: '#GALERI\\ 24 > div > div.overflow-x-scroll.hide-scroll.lg\\:overflow-visible.border > div > div:nth-child(3) > div:nth-child(2)',
